        ...
        <MDBNavbar expand="md" class="navbar navbar-expand-md navbar-dark bg-dark w-100 position-fixed" container>
            ...
            <MDBCollapse class="justify-content-end" v-model="collapse1" id="navbarSupportedContent">
                ...
                <div class="d-flex align-items-center w-md-100">
                    <MDBNavbarNav v-if="(user === null)" class="w-100">
                    ...
                    <MDBNavbarNav v-else class="w-100">
                        <button v-on:click="logoutUser" class="nav-link nav-link-bg btn shadow-0 text-light me-3 px-3">
                            LogOut
                        </button>
                        <MDBNavbarItem>
                            <!-- Navbar dropdown -->
